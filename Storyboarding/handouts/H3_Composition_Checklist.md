...
**Does it read at thumbnail size?**
Shrink it, blur it, or squint at it. If the subject and the action aren't legible at that size, they aren't legible. This is the squint test and you should be running it constantly, not once at the end.

**Does the figure separate from the ground?**
Dark figure on light ground, or light on dark. The failure case is mid-value on mid-value. **This is the number one reason student panels fail, and it has nothing to do with drawing ability.**
...
**Does it contrast with the panel before it?**
Wide → close. Light → dark. Empty → full. If two consecutive panels have the same composition, the cut is invisible in the bad way. **Composition in this class is always a question about two frames, not one.**

---

## The three-value discipline
