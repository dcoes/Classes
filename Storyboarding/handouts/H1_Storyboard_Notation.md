...
These are different marks and they mean different things. Confusing them is the most common notation error there is, and it makes an animator build the wrong shot.
...
| Notation | Move | What's happening |
|---|---|---|
| **PAN L / PAN R** | Pan | Camera pivots horizontally. It does not travel. |
| **TILT UP / TILT DN** | Tilt | Camera pivots vertically. It does not travel. |
| **TRUCK IN / TRUCK OUT** | Dolly | Camera physically travels toward or away from the subject. |
| **TRACK L / TRACK R** | Tracking | Camera travels alongside the subject. |
...
## Showing a move across one panel

For a pan or a truck, draw the **widest extent** of the move and box the start and end frames inside it.
...
| Notation | Means |
|---|---|
| **CUT** | Hard cut to the next panel. This is the default; you only write it when you need to be explicit. |
| **DISS** | Dissolve. Note the length: `DISS (1 sec)`. |
| **FADE IN / FADE OUT** | To or from black. `FADE OUT (2 sec)`. |
| **HOLD** | The frame stays. Always give a duration: `HOLD 3 sec`. |
| **MATCH CUT** | The next panel is a graphic or action match on this one. |
| **CONT.** | Action continues into the next panel without a cut. |
...
Notation exists so that someone who was not in the room can build your shot without asking you a question. If a mark on your board needs you standing next to it to be understood, it isn't notation yet.
