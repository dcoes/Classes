...
The audience won't be able to tell you what's wrong. They'll say it "feels off." That is what a broken line feels like from the audience seat.

**Distant characters still have a line.** Two people on the phone in two cities: establish the imaginary line anyway, so they face each other across the cut.

### Three legal ways to cross it
...
Which way a person moves or looks, held consistently across shots. It's a promise you make to the audience in the first shot.

| Type | What it is | Use it for |
|---|---|---|
| **Neutral** | Movement toward or away from camera | The safe cut between two contradicting directions |
| **Constant** | One direction only, held | Any journey. The bus goes left-to-right, or the audience thinks it turned around. |
| **Contrasting** | Enter one side, exit the other | Reversal. Left-to-right leaving, right-to-left returning. |
...
## Cut late enough to be understood

Cut only after the audience has taken in the information.

- Too fast → they miss it → the sequence reads as *confusing*
- Too long → they're annoyed → the sequence reads as *slow*

Both failures look like "bad sequence" and they have opposite fixes. Learn to tell them apart. You'll get the actual numbers in the animatic session (H5).
