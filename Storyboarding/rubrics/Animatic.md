...
| | Pts | Full credit |
|---|--:|---|
| Resolution and ratio | 5 | 1920×1080 baseline for 16:9, or the assigned ratio. 2× where a push or pan is planned. |
| Naming and numbering | 5 | `SEQ01_SH010.png` convention, **incrementing by ten.** Consistent across every file. |
| Layer separation | 5 | Anything that moves independently is on its own layer, with the hole behind it filled. Both `.psd` and `.png` delivered. |
...
| | Pts | Full credit |
|---|--:|---|
| Every panel timed | 8 | The full sequence is cut. No placeholder gaps. |
...
| | Pts | Full credit |
|---|--:|---|
| Temp audio present | 6 | Music or ambience under the whole sequence. |
...
**Drawing quality.** It is barely relevant here and the assignment is structured to prove that. A crude animatic with excellent timing is a good animatic. A beautiful one with bad timing is not.

**Effects, transitions, or polish.** Cuts are 90% of transitions in finished films and they should be 90% of yours. A dissolve you can't justify costs more than it earns.

---

## The failure this assignment exists to catch

Students time from memory. They don't use a stopwatch, because they believe they already know how long things take.
