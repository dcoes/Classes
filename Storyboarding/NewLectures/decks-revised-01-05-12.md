...
- Added: crude production boards, the survival kit, notation.
...
*Say: nothing yet. Go straight to slide 2.*

**2 · Three images**
Finished concept art · a real production board panel (crude, arrows, scratchy) · the final film frame that panel became.
*Say: which of these was made by the person with the most important job on this film? Let them answer wrong.*

**3 · The thesis**
> A storyboard's only job is to make a sequence understandable and engaging before anyone spends money.
...
A method of organizing visual ideas graphically for film, animation, or games. A number of panels showing the visual action of a sequence in logical narrative order.
*(Your original slides 4–6, consolidated.)*
...
Film and animation: audience watches. Games and interactive: user watches *and* manipulates.
*Say (30 sec, earns the room): the grammar is the same. What changes is who controls the camera. We'll spend a whole session on this later.*

**8 · One thing hasn't changed**
Whatever the medium, the storyteller's purpose is the same: communicate a message to an audience, and hold their attention while you do it.
...
**9 · The oldest rule**
"Show, don't tell."
*Say: this is the basis of all visual writing, and it is the standard I grade against.*

**10 · Telling**
Text on screen: *Jack was tired of waiting and a little bitter about it.*
*Say: what do you picture? Everyone in this room pictured something different. That's a failure of a production document.*

**11 · Showing**
The image: Jack kicks up dirt as he pulls a cigarette from behind his ear.
*Say: now we all see the same thing. Same information, delivered visually. That's the job.*
*(Your original slides 16–19, tightened.)*

**12 · A worked contrast**
Side by side: "The child no longer lives at home" / an image of a mother absently touching frayed toys in an empty child's room.
*Say: the second one is richer AND shorter. That's what visual economy buys you.*
*(Recovered from your original slide 64.)*
...
**15 · What they just did**
Beginning · Middle · End. Act 1 · Act 2 · Act 3.
*Say: you just derived three-act structure from a cartoon in four minutes. You already know this. What you don't know yet is how to stage it.*
...
**17 · The hook**
The opening beat that raises a question. A murder, a kidnapping, an eviction notice, a couple splitting up.
*Say: the hook doesn't have to be big. It has to be unanswered.*
*(Your original slides 38–40, compressed from three to one.)*
...
**18 · Campbell**
Joseph Campbell, *The Hero with a Thousand Faces*. Found the same pattern in hero myths across unrelated cultures. Called it the monomyth.
*Say: I'm not teaching you this so you can write. I'm teaching it because every stage of it is a staging problem, and knowing which stage you're in tells you where to put the camera.*
...
**21 · Call to Adventure → the staging problem: the beat that breaks the pattern**
- A cut that violates the rhythm you just built
- Something enters frame that doesn't belong
- Shot size change as an alarm
*Say: the audience should feel the break before they understand it.*
...
Doors, gates, tunnels, horizons, water's edge, the ramp of a ship.
*Say: this is the most reliably visual moment in the whole structure. Board artists love it because the metaphor is already a set.*
...
- Your widest and your tightest shot probably both live here
- Cutting rate changes
- This is where you spend your best drawing
*Say: budget your effort. Most student boards are evenly rendered, which means nothing is emphasized.*
...
*Say: in every case, someone else's vision. Your job is to make it legible, then make it better.*
...
**31 · "I can't draw"**
Callback to slide 4's crude production boards.
*Say: you are not being asked to draw. You are being asked to notate.*

**32 · The three-shape figure**
Head (circle) · ribcage (oval or box) · pelvis (box). Line of action first, shapes second.
*Demo live: ten figures in ninety seconds.*
...
*Say: detail where it matters, nowhere else. A rendered face on an unreadable pose is a wasted hour.*

**35 · Notation**
Motion arrow vs. camera arrow · pan · truck in/out · cut · hold · panel numbering.
*Hand out H1. Say: this is the actual professional shorthand. Learn it now and you'll never write a paragraph where an arrow would do.*
...
A panel in an animatic may hold for 12 frames. A shot in a finished film often less.
*Say: composition isn't decoration. It's a delivery deadline.*

**4 · Where the eye goes first**
Same image, three versions, with an eye-path overlay.
*Say: value contrast wins. Then movement. Then faces. Then everything else.*

**5 · The elements you're working with**
Line · shape · direction · size · texture · **value**.
*(Your original slide 2 list, minus color, which moves to the lighting deck.)*
*Say: value is doing more work than the other five combined. We'll come back to it.*

**6 · Reading order**
Western audiences scan left-to-right, foreground-to-background, light-to-dark.
*Say: you can fight this, but only on purpose.*
...
*Say: everything a board needs, it can do in three values. More than that is usually procrastination.*

**8 · The squint test**
Same panel, blurred/thumbnailed.
*Say: if it doesn't read at thumbnail size, it doesn't read. Squint at your own work constantly.*

**9 · Figure/ground separation**
Dark figure on light ground · light on dark · the failure case (mid on mid).
...
**11 · Value as depth**
Near = darker/higher contrast. Far = lighter/lower contrast.
*Say: this is the cheapest depth cue you own, and it works even if your perspective is wrong.*
...
*(Your original slide 28.)*
*Say: negative space isn't empty. In a 2.39 frame, the gap between two characters is often the subject.*

**17 · Headroom, lookroom, leadroom** ← **new**
Diagrams of each, plus the failure case of each.
- Headroom: space above the head, varies by shot size
- Lookroom / nose room: space in the direction they're looking
- Leadroom: space in the direction they're moving
*Say: this is checkable. You can fix half your panels in ten minutes by applying just this slide.*

**18 · Frame within a frame** ← **new**
Doorways, windows, mirrors, arches, foreground silhouettes.
*Say: cheap to draw, instantly sophisticated, and it isolates your subject without a single line of perspective.*
...
*Say: the fastest way to point at something without pointing at it.*
...
*Reframed: proximity groups characters into "sides." Repetition builds a visual motif across a sequence. Continuation carries the eye across a cut.*
...
**24 · Rhythm and proportion, for sequences** ← reframed
*(Your original slides 16–17, merged and repurposed.)*
*Say: rhythm in a single frame is repetition. Rhythm across a sequence is your cutting pattern. Both matter; the second one matters more here.*
...
*Say: composition in this class is always a question about *two* frames, not one.*

**26 · Contrast across the cut**
Wide → close. Light → dark. Empty → full.
*Say: if consecutive panels have the same composition, the cut is invisible in the bad way.*
...
*Example: the bone-to-spacecraft cut in* 2001.
*Say: your continuity lecture will show you this again. It's compositional AND editorial.*

**29 · Motif and visual echo**
Repeating a composition to mean something.
*Callback to the Hero's Journey "return" slide.*
*Say: same frame, changed meaning. That's the whole trick.*
...
- Does it contrast with the panel before it?

**31 · Live fix**
Put up a deliberately weak panel (make one, or use an anonymized past student panel with permission). Fix it with the class using only the checklist.
*Say: no redrawing. Every fix here is a compositional decision, not a drawing skill.*

**32 · Exit exercise**
Take any three panels from your current assignment. Run the checklist. Post the before/after of one.
...
*Say: and the animatic is where mistakes get caught while they're still cheap.*

**5 · Who uses it**
Director (visualize) · animators (timing template) · actors (react to things that aren't there) · VFX (timing issues) · voice/sound (feel for the action).

**6 · The economics**
Without a well-timed animatic, a shot can take three to four times longer to build.
*Say: this is why you're doing this and not just handing me panels.*

**7 · No fixed rules**
Studios differ. The artist keeps creative license to emphasize a beat over the stopwatch.
...
Hand-drawn, from your own boards, cut in AE or an NLE.
...
**16 · Document setup**
Your panels should already be at the delivery ratio from your template assignment. Panels as separate documents or artboards, not one big page.
...
**18 · Export**
PNG for lossless with transparency · JPG only for flattened stills you'll never re-edit · never GIF.
...
*Say: you cannot invent detail you didn't draw. Plan the move before you draw the panel.*

**21 · Importing to After Effects**
File → Import → choose the first file → check "PNG Sequence" (or import as individual layers for hold-based editing).
*Demo this live.*
...
**23 · What to use**
Temp music · ambience · a few key effects · scratch dialogue you record yourself on your phone.
*Say: scratch dialogue recorded badly by you beats no dialogue. Timing needs a voice to time against.*

**24 · Sourcing legally**
Freesound, YouTube Audio Library, Pixabay, Incompetech, CC-licensed tracks. Credit your sources in your submission.
*Say: temp tracks in the industry are pulled from released films and replaced later. For your portfolio, use licensed or CC material so you can actually show the work.*
...
*Say: pick one at the start and never change it.*

**27 · Too long / too short**
Too long: pace drags, audience bored. Too short: ambiguous, audience confused.
*Say: both failures look like "bad animatic" and they have opposite fixes. Learn to tell them apart.*

**28 · Hold-length reference** ← **new**

| Shot type | Typical hold |
|---|---|
| Establishing shot | 3–4 sec |
| Wide, new information | 2–3 sec |
| Dialogue beat | ~2 sec |
| Reaction | 0.75–1.5 sec |
| Insert / detail | 0.5–1 sec |
...
**32 · Iterate**
An NLE makes adding or removing frames trivial. Your first timing pass will be wrong. Budget for three passes.
