...
You answered this for the boards. Answer it again for the timing, because they are different questions. A sequence that reads correctly as a set of panels can be paced into something that doesn't work at all.
...
An animatic is **not a prototype of the film.** It's a prototype of the **film experience.**

That's why timing and temp audio matter more here than drawing does. You are testing whether the sequence *feels* like what you intended, and feel is a function of duration and sound, not of rendering.
...
**Plan the move before you draw the panel.** For a pan, draw wider than the frame. For a push, draw larger than the frame. You cannot invent detail you didn't draw.

Sloppy file prep is not a minor sin. It makes the next three stages take four times as long, which is exactly what it does on a real production.
...
Photoshop or Photopea for the stills. After Effects, DaVinci Resolve, or Premiere for the cut. Any NLE is fine.
...
**Drawing quality.** It is barely relevant here, and the assignment is built to prove it. A crude animatic with excellent timing is a good animatic. A beautiful one with bad timing is not.

**Transitions and polish.** Cuts are over 90% of transitions in finished films and they should be about 90% of yours. A dissolve you can't justify costs more than it earns.

---

## The failure this assignment exists to catch

Students time from memory, because they think they already know how long things take.
